 ...
 */
spiConfig_t spi_conf = {SPI_1, MASTER, MODE0, SPI_BR, SPI_DMA, NULL};

spiPort_t ili9341_spi;							/*!< uC SPI port */
gpioPin_t ili9341_cs, ili9341_dc, ili9341_rst;	/*!< uC GPIO ports to use as CS, DC and RST */
